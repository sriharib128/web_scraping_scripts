...
with open("medyblog_links.pkl","rb") as fi:
...
def scrape_page(pages_10_number):
    ...
    start = time.time()
    with open(f'./medyblog_text_files/medyblog_10_{pages_10_number}.txt', 'w') as f:
            ...
            for _ in range(max_retries):
                try:
                    ...
                    if response.status_code == 200:
                        ...
                        div_with_class = soup.find("div", class_="moHCnT")
