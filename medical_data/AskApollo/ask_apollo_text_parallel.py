...
with open("ask_apollo.pkl","rb") as fi:
...
#div class
#  td_block_wrap tdb_single_content tdi_43 td-pb-border-top td_block_template_1 td-post-content tagdiv-type
# ALL P TAGS
# data-td-block-uid="tdi_43"
def scrape_page(pages_10_number):
    pages_10 = links_ten[pages_10_number]
    start = time.time()
    with open(f'./ask_apollo_text_files/askapollo_10_{pages_10_number}.txt', 'w') as f:
            ...
            for _ in range(max_retries):
                try:
                    ...
                    if response.status_code == 200:
                        ...
                        div_class = "td_block_wrap tdb_single_content tdi_43 td-pb-border-top td_block_template_1 td-post-content tagdiv-type"
                        block_uid = "tdi_43"
                        div_element = soup.find('div', class_=div_class, attrs={'data-td-block-uid': block_uid})
...
for i in range(pages_10_number):
    scrape_page(i)
